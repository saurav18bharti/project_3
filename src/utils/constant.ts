export const app_style="bg-card-bg-color flex flex-col justify-center items-center gap-8 rounded-2xl max-w-[789px] py-16 mx-4 my-12 md:mx-auto drop-shadow-md"
export const max_width_content ="max-w-[28rem]"
export const button_style = "text-sm xl:text-sm bg-header-button-2 py-3 w-full rounded-xl transition   hover:bg-violet-300 hover:font-semibold shadow-md shadow-black "
