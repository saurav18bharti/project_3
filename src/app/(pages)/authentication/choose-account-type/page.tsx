...
const ChooseAccountType = () => {
  ...
  <div className='flex flex-col gap-6 px-8 md:px-0'>
      ...
      <Link href="/authentication/account-info" className='w-full'><button className="text-sm bg-header-button-2 py-2   max-w-2xl min-w-72 w-full rounded-xl  flex justify-center items-center gap-1">submit <MdKeyboardArrowRight className='h-5 w-5 text-gray-500'/></button></Link>
  </div>
        </div>
