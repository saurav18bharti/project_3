      ...
      <div className=" max-w-[23rem] flex flex-col gap-4 w-full">
        <div className="flex flex-col gap-6">
          <div className="flex flex-col justify-center items-center gap-2 xl:gap-4">
            ...
            <h3 className=" text-base  text-card_text_color opacity-70">
        ...
        <div className="flex justify-center items-center w-full gap-3">
          ...
          <p className="text-base  text-card_text_color opacity-70 font-normal">
            Or with Email
          </p>
        ...
        <div className="flex flex-col justify-center items-center gap-5 xl:gap-10 px-8 md:px-0 w-full">
          <div className="flex flex-col gap-3 xl:gap-5 w-full">
            <Input />
            <Link href="/authentication/two-step-verification">
              <h4 className="text-blue_text_color  text-base font-normal text-end hover:text-white hover:scale-[1.03 active:scale-[1.008] ">
                Forgot Password?
              </h4>
            </Link>
          </div>
          ...
          <div className=" flex justify-center items-center gap-1 md:gap-2   ">
            <p className="text-base  text-card_text_color opacity-80 font-normal">
              Not a Member yet?
            </p>
            <Link href="/authentication/signup">
              <span className="text-base text-blue_text_color">Sign Up</span>
            </Link>
          </div>
        </div>
      </div>
