    ...
    <>
      {data.map((item, index) => (
        <div
          ...
          } flex flex-col gap-4 p-8 rounded-xl hover:bg-white cursor-pointer transition hover:duration-100 hover:shadow-md hover:shadow-black `}
        >
          ...
          <div className="flex justify-between items-center gap-12">
            ...
            <div className={`flex justify-between items-center ${pathname === "/overview/dashboard-eCommerce" ? "gap-0" : "gap-4"} text-lg`}>
